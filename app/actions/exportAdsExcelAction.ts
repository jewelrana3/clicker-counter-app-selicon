...
export async function exportAdsExcelAction() {
  try {
    ...
    const res = await fetch(`${baseUrl}/advertisements/export-to-excel`, {
      method: "GET",
      headers: {
    ...
    let filename = `advertisements-${new Date().toISOString().split("T")[0]}.xlsx`;
